...
class TwigExtension extends \Twig_Extension {
  ...
  public function getFunctions() {
    return [
      new \Twig_SimpleFunction('drpn_drupal_view', 'views_embed_view'),
      new \Twig_SimpleFunction('drpn_drupal_block', [$this, 'drupalBlock']),
      new \Twig_SimpleFunction('drpn_drupal_token', [$this, 'drupalToken']),
      new \Twig_SimpleFunction('drpn_drupal_entity', [$this, 'drupalEntity']),
      new \Twig_SimpleFunction('drpn_drupal_field', [$this, 'drupalField']),
      new \Twig_SimpleFunction('drpn_drupal_menu', [$this, 'drupalMenu']),
      new \Twig_SimpleFunction('drpn_drupal_config', [$this, 'drupalConfig']),
      new \Twig_SimpleFunction('drpn_theme_setting', [$this, 'themeSetting']),
    ];
  }
