...
/* themes/drupalet_arco/templates/navigation/menu.html.twig */
class __TwigTemplate_680417c09fcd9c96f4bc2e9e9a9db1c3112cd79fd634a17d171414961ecb5db1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    ...
                    // line 14
                    echo "\t  <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "navbar-nav ml-auto"], "method", false, false, true, 14), 14, $this->source), "html", null, true);
                    echo " id=\"main-menu\">
    ";
                } elseif ((                // line 15
...
\t  <li ";
  ...
  ";
    ...
    {
        return "themes/drupalet_arco/templates/navigation/menu.html.twig";
    }
...
\t\t{% set menu_a = 'nav-link' %}
\t  <ul{{ attributes.addClass('navbar-nav ml-auto') }} id=\"main-menu\">
    {% elseif menu_level == 1 %}
...
\t  <li {{ item.attributes.addClass(classes) }} {{ menu_level }}>
  ...
  {% endif %}
{% endmacro %}
", "themes/drupalet_arco/templates/navigation/menu.html.twig", "/var/www/html/themes/drupalet_arco/templates/navigation/menu.html.twig");
    }
